...
// This is using Replit's AI Integrations service or a standard Google API key
const ai = new GoogleGenAI({
  apiKey: process.env.AI_INTEGRATIONS_GEMINI_API_KEY || process.env.GOOGLE_API_KEY,
  httpOptions: {
    apiVersion: "",
